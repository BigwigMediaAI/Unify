...
const Team: React.FC = () => {
  ...
  return (
    <div className="bg-black text-white">
      <Nav2 />
      <section className=" container mt-10 mx-auto py-12 px-4 lg:px-8">
        <div className="md:w-11/12 mx-auto md:px-8 gap-8">
          ...
          <div className=" bg-gray-100 p-6 rounded-lg shadow-lg">
            ...
            <h2 className="text-gray-700 text-center font-bold mt-5 text-2xl">
              {" "}
              About Unifyi
            </h2>
            <h2 className="text-gray-600 text-justify md:text-center mt-4">
              Step up, folks, and prepare to be amazed by the spectacle that is
              Unifyi! Picture it: An AI-fuelled, SAAS platform that acts as a
              one-stop-shop for managing leads through the maze-like hilarity
              that is the universities and institutions admission process. Think
              of Unifyi as your ticket to the roller coaster ride of lead
              capture, nurturing, and conversion into admissions, all without
              losing your hair (or your sanity).
            </h2>
            <h2 className="text-gray-600 text-justify md:text-center mt-4">
              And here's the cherry on top- an unstoppable squad of over 40
              dedicated experts, tirelessly working 24/7. They might not wear
              superhero capes but, their mission? To offer you the
              best-customized solutions! Whether your institution requires a
              simple solution or complex adjustments, they've got your back!
